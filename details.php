...
// Set the business_id from the URL if not set in the session
if (isset($_GET['businessId'])) {
    $_SESSION['business_id'] = $_GET['businessId'];
}

$businessId = $_SESSION['business_id'] ?? null; // Get businessId from session
...
$stmt->bind_param("i", $businessId); // Use $businessId here
$stmt->execute();
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['submitRedirect'])) {
    ...
    $stmt->bind_param("si", $redirectLink, $businessId); // Use $businessId here
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['socialLinks'])) {
    ...
    $stmt->bind_param("si", $socialLinksJson, $businessId); // Use $businessId here
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['businessName'])) {
    ...
    $stmt->bind_param(
        ...
        $logo,
        $redirectLink,
        $businessId // Use $businessId here
    );
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form method="POST" enctype="multipart/form-data">
                            <input type="hidden" name="id" value="<?php echo $businessId; ?>">
                            <div class="col-md-12">
                                <div class="row">
                                    <!-- Logo -->
                                ...
                                <div class="link-input-container">
                                    ...
                                    <div class="link-wrapper">
                                        <span id="staticLink" class="feedback-link">
                                            https://quickrate.in/user-feedback/<?php echo urlencode($businessName); ?>
                                        </span>
